...
def create_snippet(link, timestamp, amount=1):
    ...
    for i in range(0, amount):
        ...
        i = 0
        audio_file_name = f"C:/Users/blura/Desktop/Voice Bachelor proj/noise2/random_noise_{i}.wav"
...
def store_values_enter(event):
    ...
    create_snippet(link, timestamp,amount)
...
entry_amount.grid(row=2, column=1, padx=10, pady=10, columnspan=2)
enter_button.grid(row=3, column=0, columnspan=3, pady=10)
